                ...
                <section>
                    <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44">
                        <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
                            ...
                            <Image
                                className="-z-10 order-first ml-auto h-56 w-full object-cover invert sm:h-96 lg:absolute lg:inset-0 lg:-right-20 lg:-top-6 lg:order-last lg:h-max lg:w-1/3 lg:object-contain dark:mix-blend-lighten dark:invert-0"
                                src="/image.png"
                                alt="Abstract Object"
                                height="500"
                                width="300"
